#
# OMNeT++/OMNEST Makefile for Test_Threshold
#
...
OBJS = \
    ...
    $O/Model1_Sim2_Hub.o \
    $O/Model1_Sim2_OBN.o \
    $O/Model1_Sim2_Sensor.o \
    $O/DataAggregationMessage_m.o \
    $O/FeedbackThresholdMsg_m.o \
    $O/SensorNodeMsg_m.o

# Message files
MSGFILES = \
    DataAggregationMessage.msg \
    FeedbackThresholdMsg.msg \
    SensorNodeMsg.msg
